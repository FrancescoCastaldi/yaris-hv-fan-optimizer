...
if %ERRORLEVEL% EQU 0 (
    ...
    copy /Y "app\build\outputs\apk\release\app-release.apk" "YarisHvFanControl-v2.9.8.apk"
    copy /Y "app\build\outputs\apk\release\app-release.apk" "docs\YarisHvFanControl.apk"
    copy /Y "app\build\outputs\apk\release\app-release.apk" "docs\YarisHvFanControl-v2.9.8.apk"
