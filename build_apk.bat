...
if %ERRORLEVEL% EQU 0 (
    ...
    echo Creazione copia locale: YarisHvFanControl-v3.0.1.apk
    copy /Y "app\build\outputs\apk\release\app-release.apk" "YarisHvFanControl-v3.0.1.apk"

    echo Copia nella cartella docs per GitHub Pages...
    copy /Y "app\build\outputs\apk\release\app-release.apk" "docs\YarisHvFanControl-v3.0.1.apk"
    ...
    echo   1. YarisHvFanControl-v3.0.1.apk
