...
if %ERRORLEVEL% EQU 0 (
    ...
    copy /Y "app\build\outputs\apk\release\app-release.apk" "YarisHvFanControl-v2.9.15.apk"
    copy /Y "app\build\outputs\apk\release\app-release.apk" "docs\YarisHvFanControl-v2.9.15.apk"
    
    echo [3/3] Singolo file APK aggiornato pronto in root e docs!
    echo ========================================================
    echo   BUILD COMPLETATA CON SUCCESSO!
    echo   Singolo APK v2.9.15 generato: YarisHvFanControl-v2.9.15.apk
    echo ========================================================
) else (
