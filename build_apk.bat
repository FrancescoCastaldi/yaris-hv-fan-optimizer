...
if %ERRORLEVEL% EQU 0 (
    ...
    copy /Y "app\build\outputs\apk\release\app-release.apk" "YarisHvFanControl-v2.9.20.apk"
    copy /Y "app\build\outputs\apk\release\app-release.apk" "docs\YarisHvFanControl-v2.9.20.apk"
    ...
    echo   1. YarisHvFanControl-v2.9.20.apk
